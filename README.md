...
synthetic fixtures only, so the per-model cost may be off. Reports with a real
...
```sh
git clone https://github.com/gabrielsitta4/cctop.git ~/.local/share/cctop
```
...
# KDE
ExecStart=%h/.local/share/plasma/plasmoids/com.gabrielsitta4.cctop/contents/code/summary.sh
# GNOME
# ExecStart=%h/.local/share/gnome-shell/extensions/cctop@gabrielsitta4/code/summary.sh
Restart=on-failure
RestartSec=60
```
...
[GPL-3.0-or-later](LICENSE), © 2026 gabrielsitta4
